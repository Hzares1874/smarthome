...
extern char *cmdLED_On;      //LED打开
extern char *cmdLED_Off;    //LED关闭

extern char *cmdDHT11_On;    //温湿度数据传输打开
extern char *cmdDHT11_Off;  //温湿度数据传输关闭

extern char *ledFlag;       //LED状态
extern int   dhtFlag;		        //温湿度数据传输状态
...
//					LED_Off(); 								                //LED关闭
//				}
				if(!memcmp(&MQTT_CMDOutPtr[2],cmdDHT11_On,strlen(cmdDHT11_On)))//判断指令，如果是CMD3
				{      
